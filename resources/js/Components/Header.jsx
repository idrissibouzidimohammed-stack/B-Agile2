...
export default function Header() {
    ...
    return (
        <header className="fixed top-4 left-0 right-0 z-50 px-4 md:px-6">
            ...
            <nav className="max-w-6xl mx-auto bg-purple-950/80 border border-purple-800/60 backdrop-blur-md rounded-full px-6 py-0.5 flex items-center justify-between shadow-[0_10px_35px_rgba(45,10,80,0.5)] relative overflow-hidden">
